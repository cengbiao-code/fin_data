...
REQUIRED_LABEL_PATTERNS_BY_MARKET: dict[str, dict[str, list[list[str]]]] = {
    ...
    "hk": {
        ...
        "statement.income_statement": [
            ["期內盈利", "期內虧損", "年內溢利", "年內虧損", "年內（虧損）", "profit for the period", "profit for the year"],
            ["每股盈利", "每股基本", "每股虧損", "每股（虧損）", "earnings per share", "eps"],
            ["經營盈利", "經營虧損", "經營（虧損）", "operating profit"],
        ],
        "statement.cash_flow": [
            ["經營活動所得現金流量淨額", "經營活動產生的現金流量淨額", "經營活動所用", "經營活動（所用）", "net cash generated from operating activities"],
            ["投資活動耗用現金流量淨額", "投資活動所用現金流量淨額", "投資活動所得現金流量淨額", "net cash used in investing activities"],
            ["融資活動所得現金流量淨額", "融資活動（耗用）", "融資活動所用", "融資活動所得", "net cash generated from financing activities"],
